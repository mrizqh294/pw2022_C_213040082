...
<html lang="en">
  <head>
    ...
    <!-- my style -->
    <link rel="stylesheet" type="text/css" href="../style/style.css?x=1">
    <link rel="stylesheet" type="text/css" href="../style/responsive.css?x=1">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-end">
              <form class="d-flex" action="" method="POST">
                <input class="form-control me-2" type="search" placeholder="Cari Produk" aria-label="Search" name="keyword" autocomplete="off" id="keyword2">
              </form>
            </div>
          </div>
