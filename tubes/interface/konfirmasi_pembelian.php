...
$id = $konfirmasi['id_produk'];

$p = query("SELECT * FROM produk WHERE kode_produk = $id");
  ...
  if ( konfirmasi($_POST) > 0) {
    echo "
      <script>
        ...
        document.location.href='../interface/pesanan.php';
      </script>
    ";
  } else {
    echo "
      <script>
        alert('Gagal membeli produk. Periksa koneksi jaringan anda kemudian coba lagi.');
        document.location.href='../interface/halaman_user.php';
      </script>
    ";
  }
}
...
<html lang="en">
  <head>
    ...
    <!-- my style -->
    <link rel="stylesheet" type="text/css" href="../style/style.css?x=5">
    <link rel="stylesheet" type="text/css" href="../style/responsive.css?x=5">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="halaman_detail.php?kode_produk=<?php echo $p[0]['kode_produk'] ?>">Kembali</a>
            </li>
            <li class="nav-item">
   ...
   <section class="w-100 pt-5 ">
     <div class="row h-100 w-100  mx-auto detail pt-5 pt-lg-0 ps-3 ps-lg-0 pe-3 pe-lg-0 pb-4 pb-lg-0  ">
       <div class="col-md-10 my-auto mx-auto p-4 shadow-sm rounded border bg-white ">
         <div class="col-md-12">
          <h3 class="fw-bold text-center">Konfirmasi Pembelian Produk</h3>
           <div class="row pt-3">
             <div class="col-md-6 my-auto text-center text-lg-start">
              <img src="../aset/img/<?php echo $p[0]['gambar_produk'] ?>" width="70%">
               
             </div>
             <div class="col-md-6 my-auto">
              <div class="col-md-12 text-center text-lg-start">
                <p class="fw-bold text-justify">Detail Pemesanan</p>
                <p><span>Nama Produk : <?php echo $p[0]['nama_produk']; ?></span></p>
                <p><span>Nama Penerima : </span> <?php echo $userLogin['nama_user']; ?></p>
                <p>Pengirim : 294 Store</p>
                <p><span>Jumlah Produk : </span><?php echo $konfirmasi['jumlah_pesan'] ?></p>
                <p><span>Total Bayar : </span><?php echo $konfirmasi['total_bayar'] ?></p>
                <form action="" method="POST" >
                  <p>Alamat pengiriman :</p>
                  <!-- tabel transaksi -->
                  <input type="hidden" name="id_user" value="<?php echo $userLogin['id_user'] ?>">
                  <input type="hidden" name="total_bayar" value="<?php echo $konfirmasi['total_bayar'] ?>">
                  <!-- tabel transaksi produk -->
                  <input type="hidden" name="jumlah_produk" value="<?php echo $konfirmasi['jumlah_pesan'] ?>">
                  <input type="hidden" name="id_produk" value="<?php echo $id ?>">

                  
                  <textarea name="alamat_pengiriman" class="inputText"><?php  echo $userLogin['alamat_user'] ?></textarea>
                  <div class="col-md-12">
                    <button type="submit" name="konfirmasi" class="bg-dark more-con text-white">Konfirmasi</button>
                  </div>
                </form>
              </div>
             </div>
