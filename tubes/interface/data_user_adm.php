          ...
          <table class="table-bordered " cellpadding="10"  >
            ...
            <tbody>
                ...
                <tr class="align-middle p-2">
                  ...
                  <td scope="col"><?php echo $u['nama_user'] ?></td>
                  <td scope="col"><?php echo $u['email_user'] ?></td>
                  <td scope="col"><?php echo $u['username_user'] ?></td>
                  <td scope="col"><?php echo $u['alamat_user'] ?></td>
                </tr>
