                ...
                <div class="col-6 col-md-3">
                  <div class="card c-admin p-2 pb-0 shadow-sm bg-body rounded mt-4">
                    ...
                    <div class="text-center action mb-3">
                      <a href="detail_pesanan_admin.php?kode_produk=<?php echo $k['kode_produk'] ?>&id_user=<?php echo $k['id_user'] ?>&id_transaksi=<?php echo $k['id_transaksi'] ?>" class="bg-dark more">Detail</a>
                    </div>
                  </div>
                </div>
